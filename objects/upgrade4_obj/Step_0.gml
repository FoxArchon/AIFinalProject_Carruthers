...
if(modifiedAI_obj.aiWantsLaser == true)
{
...
instance_create_layer(modifiedAI_obj.x,modifiedAI_obj.y - 27,"AboveShipUpgrades",laserAttatchment2_obj);
...
modifiedAI_obj.aiHasLaser = true;

modifiedAI_obj.aiWantsLaser = false;
